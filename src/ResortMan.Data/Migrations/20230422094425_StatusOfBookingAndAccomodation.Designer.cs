...
namespace ResortMan.Data.Migrations
{
    ...
    [Migration("20230422094425_StatusOfBookingAndAccomodation")]
    partial class StatusOfBookingAndAccomodation
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ResortMan.Data.ApplicationUser", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("nvarchar(450)");
            ...
            modelBuilder.Entity("ResortMan.Data.ApplicationUserRole", b =>
                {
                    b.Property<string>("UserId")
                        .HasColumnType("nvarchar(450)");
            ...
            modelBuilder.Entity("ResortMan.Entities.AccomodationPackagePicture", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.ToTable("AccomodationPackagePictures");
                });
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("ResortMan.Data.ApplicationUser", null)
                        .WithMany()
            ...
            modelBuilder.Entity("ResortMan.Data.ApplicationUserRole", b =>
                {
                    ...
                    b.HasOne("ResortMan.Data.ApplicationUser", "User")
                        .WithMany("UserRoles")
                        .HasForeignKey("UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
