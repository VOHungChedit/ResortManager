...
namespace ResortMan.MvcApp.Areas.Dashboard.Controllers
{
    ...
    public class AccomodationPackagesController : Controller
    {
        ...
        public AccomodationPackagesController(AccomodationPackagesService accomodationPackagesServices)
        {
            this.accomodationPackagesService = accomodationPackagesServices;
        }
